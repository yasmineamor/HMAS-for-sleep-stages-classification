...
public class choix_A {
   ...
   public int fun (String env_file_name, String state)
    { 
			 ...
			 int exploreProbC=0;
			 Environment e = null;
			 String[] arg ={env_file_name, "C:\\Users\\yasmine\\Desktop\\newdb\\base10.txt", "10", "5", "1000","200", "100000", "1"};
